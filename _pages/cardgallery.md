...
cardgallery_dark_expeditions:
  ...
  - url: assets/images/games/tableau/tableaucoreaccelerated/TableauCoreAccelerated_SmallCard_01_SettingThe_Table.jpg
    ...
    title: " <strong>Setting The Table </strong> <br/><br/> This is some text after the gallery just to make sure that everything aligns properly. <br/><br/> Here comes another gallery, this time set the id to match 2nd gallery hash in YAML Front Matter."
